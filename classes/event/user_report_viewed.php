...
/**
 * The mod_foreact user report viewed event.
 *
 * @package    mod_foreact
...
/**
 * The mod_foreact user report viewed event class.
 *
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'mod_foreact');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/mod/foreact/user.php', array('id' => $this->relateduserid,
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'foreact', 'user report', $logurl, $this->relateduserid);
    }
