@mod @mod_foreact @core_tag
Feature: Edited foreact posts handle tags correctly
  In order to get foreact posts properly labelled
  As a user
  ...
  @javascript
  Scenario: foreact post edition of custom tags works as expected
    ...
    And I reply "Teacher post subject" post from "Test foreact name" foreact with:
      ...
      | Tags    | Tag1                 |
    Then I should see "Tag1" in the ".foreact-tags" "css_element"
  ...
  @javascript
  Scenario: foreact post edition of standard tags works as expected
    ...
    And I reply "Teacher post subject" post from "Test foreact name" foreact with:
      ...
      | Message | Student post message |
      | Tags | OT1, OT3 |
    Then I should see "OT1" in the ".foreact-tags" "css_element"
    And I should see "OT3" in the ".foreact-tags" "css_element"
    And I should not see "OT2" in the ".foreact-tags" "css_element"
