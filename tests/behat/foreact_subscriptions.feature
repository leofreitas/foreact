@mod @mod_foreact
Feature: A user can control their own subscription preferences for a foreact
  In order to receive notifications for things I am interested in
  As a user
  I need to choose my foreact subscriptions
  ...
  Scenario: A disallowed subscription foreact cannot be subscribed to
    ...
    Then I should not see "Subscribe to this foreact"
    And I should not see "Unsubscribe from this foreact"
  ...
  Scenario: A forced subscription foreact cannot be subscribed to
    Given I add a "foreact" to section "1" and I fill the form with:
      | foreact name        | Test foreact name |
      | foreact type        | Standard foreact for general use |
      | Description       | Test foreact description |
  ...
  Scenario: An optional foreact can be subscribed to
    Given I add a "foreact" to section "1" and I fill the form with:
      | foreact name        | Test foreact name |
      | foreact type        | Standard foreact for general use |
      | Description       | Test foreact description |
    ...
    And I should not see "Subscribe to this foreact"

  Scenario: An Automatic foreact can be unsubscribed from
    Given I add a "foreact" to section "1" and I fill the form with:
      | foreact name        | Test foreact name |
      | foreact type        | Standard foreact for general use |
      | Description       | Test foreact description |
