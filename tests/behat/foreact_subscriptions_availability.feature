...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a foreact
  As a teacher
  ...
  Scenario: A forced foreact does not allow to edit the subscribers
    When I add a "foreact" to section "1" and I fill the form with:
      | foreact name        | Forced foreact 2 |
      | foreact type        | Standard foreact for general use |
      | Description       | Test foreact description |
      | Subscription mode | Forced subscription |
      | Availability      | Show on course page |
    And I follow "Forced foreact 2"
    And I navigate to "Show/edit current subscribers" in current page administration
  ...
  Scenario: A forced and hidden foreact lists only teachers
    When I add a "foreact" to section "1" and I fill the form with:
      | foreact name        | Forced foreact 2 |
      | foreact type        | Standard foreact for general use |
      | Description       | Test foreact description |
  ...
  @javascript
  Scenario: An automatic foreact lists all subscribers
    When I add a "foreact" to section "1" and I fill the form with:
      | foreact name        | Forced foreact 1 |
      | foreact type        | Standard foreact for general use |
      | Description       | Test foreact description |
