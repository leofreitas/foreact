...
/**
 * A user selector control for potential subscribers to the selected foreact
 * @package   mod_foreact
 * @copyright 2009 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_foreact_potential_subscriber_selector extends mod_foreact_subscriber_selector_base {
    /**
     * If set to true EVERYONE in this course is force subscribed to this foreact
     * @var bool
     */
    ...
    public function find_users($search) {
        ...
        $cm = get_coursemodule_from_instance('foreact', $this->foreactid);
        ...
        if ($this->forcesubscribed) {
            return array(get_string("existingsubscribers", 'foreact') => $availableusers);
        } else {
            return array(get_string("potentialsubscribers", 'foreact') => $availableusers);
        }
    }
    ...
    /**
     * Sets this foreact as force subscribed or not
     */
