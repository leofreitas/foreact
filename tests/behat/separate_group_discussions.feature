...
Feature: Posting to all groups in a separate group discussion is restricted to users with access to all groups
  In order to post to all groups in a foreact with separate groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | foreact      | Standard foreact name    | Standard foreact description    | C1     | sepgroups    | 1         |

  Scenario: Teacher with accessallgroups can view all groups
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I follow "Standard foreact name"
  ...
  Scenario: Students can view all participants discussions in separate groups mode
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add a new discussion to "Standard foreact name" foreact with:
      | Subject | foreact post to all participants |
    ...
    And I am on "Course 1" course homepage
    And I follow "Standard foreact name"
    Then I should see "foreact post to all participants"
