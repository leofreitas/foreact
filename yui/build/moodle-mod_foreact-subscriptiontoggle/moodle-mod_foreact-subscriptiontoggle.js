YUI.add('moodle-mod_foreact-subscriptiontoggle', function (Y, NAME) {
 ...
 * @main       moodle-mod_foreact-subscriptiontoggle
 */

/**
 * @namespace M.mod_foreact
...
var LOGNAME = 'moodle-mod_foreact-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    _toggleSubscription: function(e) {
        ...
        Y.io(this.get('uri'), {
            data: {
                ...
                foreactid: clickedLink.getData('foreactid'),
    ...
    ATTRS: {
         ...
         * @attribute uri
         * @type String
         * @default M.cfg.wwwroot + '/mod/foreact/subscribe_ajax.php'
         */
        uri: {
            value: M.cfg.wwwroot + '/mod/foreact/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.mod_foreact.subscriptiontoggle');
