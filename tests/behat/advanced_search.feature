@mod @mod_foreact
Feature: The foreact search allows users to perform advanced searches for foreact posts
  In order to perform an advanced search for a foreact post
  As a teacher
  ...
  Background:
    ...
    And I add a new topic to "Announcements" foreact with:
      | Subject | My subject |
      | Message | My message |
  ...
  Scenario: Perform an advanced search using any term
    ...
    And I press "Search foreacts"
    And I should see "Advanced search"
    And I set the field "words" to "subject"
    When I press "Search foreacts"
