...
Feature: Students can choose from 4 discussion display options and their choice is remembered
  In order to read foreact posts in a suitable view
  As a user
  ...
  Background:
    ...
    And I reply "Discussion 1" post from "Test foreact name" foreact with:
    ...
    And I reply "Discussion 2" post from "Test foreact name" foreact with:
  ...
  Scenario: Display replies flat, with oldest first
    Given I reply "Discussion 1" post from "Test foreact name" foreact with:
    ...
    And I should see "Discussion contents 1, second message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' foreactpost ') and not(contains(@class, 'starter'))]" "xpath_element"
    And I reply "Discussion 2" post from "Test foreact name" foreact with:
    ...
    And I should see "Discussion contents 2, second message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' foreactpost ') and not(contains(@class, 'starter'))]" "xpath_element"
  ...
  Scenario: Display replies flat, with newest first
    ...
    Then I should see "Discussion contents 1, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 1, third message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' foreactpost ') and not(contains(@class, 'starter'))]" "xpath_element"
    And I reply "Discussion 2" post from "Test foreact name" foreact with:
      | Subject | Reply 2 to discussion 2 |
      | Message | Discussion contents 2, third message |
    And the field "Display mode" matches value "Display replies flat, with newest first"
    And I should see "Discussion contents 2, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 2, third message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' foreactpost ') and not(contains(@class, 'starter'))]" "xpath_element"
  ...
  Scenario: Display replies in threaded form
    ...
    And I should see "Reply 1 to discussion 1" in the "span.foreactthread" "css_element"
    ...
    And I should see "Reply 1 to discussion 2" in the "span.foreactthread" "css_element"
  ...
  Scenario: Display replies in nested form
    ...
    Then I should see "Discussion contents 1, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 1, second message" in the "div.indent div.foreactpost" "css_element"
    And I follow "Test foreact name"
    And I follow "Discussion 2"
    And the field "Display mode" matches value "Display replies in nested form"
    And I should see "Discussion contents 2, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 2, second message" in the "div.indent div.foreactpost" "css_element"
