...
/**
 * Strings for component 'foreact', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   foreact
...
$string['allforeacts'] = 'Todos os fóruns';
...
$string['blockafter_help'] = 'Esta configuração especifica o número máximo de mensagens que um usuário pode postar no período de tempo determinado. Os usuários com a capacidade mod/foreact:postwithoutthrottling estão isentos de limites de postagens.';
$string['blockperiod'] = 'Duração do bloqueio';
$string['blockperioddisabled'] = 'Não bloquear';
$string['blockperiod_help'] = 'Os estudantes podem ser bloqueadas para publicar em mais que um determinado número de lugares por um determinado período de tempo. Os usuários com a capacidade mod/foreact:postwithoutthrottling estão isentos de limites de postagens.';
$string['blogforeact'] = 'Fórum padrão exibido em um formato de blog';
...
$string['cannotaddteacherforeactto'] = 'Não foi possível converter o exemplo do fórum de professore à secão 0 do curso';
...
$string['cannotfindorcreateforeact'] = 'Não foi possível encontrar ou criar um fórum de avisos neste site.';
$string['cannotfindparentpost'] = 'Não foi possível encontrar a categoría superior da mensagem {$a}';
$string['cannotmovefromsingleforeact'] = 'Não foi possível mover um debate a partir de um fórum de debate simples';
...
$string['cannotmovetosingleforeact'] = 'Não foi possível mover a discussão para um fórum de uma única discussão';
$string['cannotpurgecachedrss'] = 'Não foi possível limpar feeds RSS em cache para a fonte e / ou fórum de destino (s) - verificar file permissionsforeact';
...
$string['confirmsubscribediscussion'] = 'Você realmente quer se inscrever na discussão  \'{$a->discussion}\' no forum \'{$a->foreact}\'?';
$string['confirmunsubscribe'] = 'Você deseja realmente cancelar assinatura do forum \'{$a}\'?';
$string['confirmunsubscribediscussion'] = 'Você realmente quer cancelar a inscrição do debate \'{$a->discussion}\' no forum \'{$a->foreact}\'?';
...
$string['discussionmovedpost'] = 'Esta discussão foi transferida <a href="{$a->discusshref}">aqui</a> no fórum <a href="{$a->foreacthref}">{$a->foreactname}</a>';
$string['discussionname'] = 'Título';
$string['discussionnownotsubscribed'] = '{$a->name} não será notificado de novos posts em \'{$a->discussion}\' de \'{$a->foreact}\'';
$string['discussionnowsubscribed'] = '{$a->name} será notificado de novos posts em \'{$a->discussion}\' de \'{$a->foreact}\\';
...
$string['eachuserforeact'] = 'Cada usuário inicia apenas UM NOVO tópico';
$string['edit'] = 'Editar';
...
$string['emaildigestupdated'] = 'A opção de alerta por eamil foi alterada para \'{$a->maildigesttitle}\' para o fórum \'{$a->foreact}\'. {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = 'Sua configuração padrão \'{$a->maildigesttitle}\' foi usada para o fórum \'{$a->foreact}\'. {$a->maildigestdescription}.';
...
$string['foreact'] = 'Fórum com Reações';
$string['foreact:addinstance'] = 'Adicionar novo fórum';
$string['foreact:addnews'] = 'Acrescentar aviso';
$string['foreact:addquestion'] = 'Adicionar questão';
$string['foreact:allowforcesubscribe'] = 'Permitir forçar assinatura';
$string['foreactauthorhidden'] = 'Autor (oculto)';
$string['foreactblockingalmosttoomanyposts'] = 'Você está atingindo o limite máximo de mensagens. Você publicou {$a->numposts} vezes nos últimos {$a->blockperiod} e o limite é de {$a->blockafter} mensagens.';
$string['foreactbodyhidden'] = 'Você não pode ver esta mensagem provavelmente porque ainda não publicou nada nesta discussão.';
$string['foreact:canoverridediscussionlock'] = 'Responder discussões bloqueadas';
$string['foreact:canposttomygroups'] = 'Pode enviar a todos os grupos que você tem acesso';
$string['foreact:createattachment'] = 'Criar anexos';
$string['foreact:deleteanypost'] = 'Cancelar todas as mensagens (sempre)';
$string['foreact:deleteownpost'] = 'Cancelar as próprias mensagens (com limite de tempo)';
$string['foreact:editanypost'] = 'Editar qualquer mensagem';
$string['foreact:exportdiscussion'] = 'Exportar todo o debate';
$string['foreact:exportownpost'] = 'Exportar a própria mensagem';
$string['foreact:exportpost'] = 'Exportar mensagem';
$string['foreactintro'] = 'Descrição';
$string['foreact:managesubscriptions'] = 'Gerenciar assinaturas';
$string['foreact:movediscussions'] = 'Mover discussões';
$string['foreactname'] = 'Nome do Fórum';
$string['foreact:pindiscussions'] = 'Destacar discussões';
$string['foreactposts'] = 'Mensagens do fórum';
$string['foreact:postwithoutthrottling'] = 'Isento de limite de mensagem';
$string['foreact:rate'] = 'Avaliar mensagens';
$string['foreact:replynews'] = 'Comentar o aviso';
$string['foreact:replypost'] = 'Responder às mensagens';
$string['foreacts'] = 'Fóruns com Reações';
$string['foreact:splitdiscussions'] = 'Separar discussões';
$string['foreact:startdiscussion'] = 'Iniciar novas discussões';
$string['foreactsubjecthidden'] = 'Assunto (oculto)';
$string['foreacttracked'] = 'As mensagens não lidas são evidenciadas';
$string['foreacttrackednot'] = 'As mensagens não lidas não são evidenciadas';
$string['foreacttype'] = 'Tipo de Fórum';
$string['foreacttype_help'] = '<P>Os fóruns podem ter as seguintes características:</p>
...
$string['foreact:viewallratings'] = 'Ver todas as qualificações emitidas pelos usuários';
$string['foreact:viewanyrating'] = 'Ver todas as avaliações de todos os estudantes';
$string['foreact:viewdiscussion'] = 'Ver discussões';
$string['foreact:viewhiddentimedposts'] = 'Ver mensagens escondidas';
$string['foreact:viewqandawithoutposting'] = 'Ver sempre mensagens Q e A';
$string['foreact:viewrating'] = 'Ver as suas avaliações';
$string['foreact:viewsubscribers'] = 'Ver assinantes';
$string['generalforeact'] = 'Fórum geral';
$string['generalforeacts'] = 'Fóruns gerais';
$string['hiddenforeactpost'] = 'Esconder post do fórum';
$string['inforeact'] = 'em {$a}';
...
$string['invalidforeactid'] = 'A identificação do fórum foi incorreta';
...
$string['learningforeact'] = 'Fóruns para atividades de aprendizagem';
...
$string['messageinboundfilecountexceeded'] = 'Não foi possível publicar sua resposta, já que inclui mais do que o número máximo de anexos permitidos para o fórum ({$a->foreact->maxattachments}).';
...
$string['messageinboundforeacthidden'] = 'Não foi possível publicar sua resposta, uma vez que o fórum está indisponível no momento.';
$string['messageinboundnopostforeact'] = 'Não foi possível postar sua resposta, já que você não tem permissão para postar no fórum {$a->foreact->name}.';
...
$string['modulename'] = 'Fórum com Reações';
...
$string['modulenameplural'] = 'Fóruns com Reações';
$string['more'] = 'mais';
...
$string['newforeactposts'] = 'Novas mensagens no fórum';
...
$string['nopostforeact'] = 'Sinto muito, você não pode escrever mensagens neste fórum';
...
$string['notrackforeact'] = 'Não monitorar mensagens não lidas';
...
$string['nownotsubscribed'] = '{$a->name} não receberá cópias de novos posts em \'{$a->foreact}\' por e-mail';
$string['nownottracking'] = '{$a->name} não está mais monitorando \'{$a->foreact}\'.';
$string['nowsubscribed'] = '{$a->name} receberá cópias de novas mensagens de  \'{$a->foreact}\' via e-mail';
$string['nowtracking'] = '{$a->name} está monitorando \'{$a->foreact}\'.';
...
$string['page-mod-foreact-discuss'] = 'Página do tópico de discussão do módulo fórum';
$string['page-mod-foreact-view'] = 'Página principal do módulo Fórum';
$string['page-mod-foreact-x'] = 'Qualquer página do módulo Fórum';
...
$string['pluginname'] = 'Fórum com Reações';
...
$string['posttoforeact'] = 'Enviar mensagem ao fórum';
...
$string['qandaforeact'] = 'Fórum P e R (perguntas e respostas)';
...
$string['resetforeacts'] = 'Excluir as mensagens de';
$string['resetforeactsall'] = 'Excluir todas as mensagens';
...
$string['searchforeactintro'] = 'Por favor inserir os termos para a busca em um ou mais dos seguintes campos:';
$string['searchforeacts'] = 'Buscar no fórum';
...
$string['searchwhichforeacts'] = 'Escolher os fóruns para a busca';
...
$string['singleforeact'] = 'Uma única discussão simples';
$string['smallmessage'] = '{$a->user} enviou mensagem em {$a->foreactname}';
...
$string['thisforeactisthrottled'] = 'Neste fórum o número de mensagens que você pode publicar é limitado a {$a->blockafter} mensagens no período de {$a->blockperiod}';
...
$string['trackforeact'] = 'Monitorar mensagens não lidas';
...
$string['unsubscribeallconfirm'] = 'Atualmente você está assinando {$a->foreacts} fóruns e {$a->discussions} discussões. Você realmente quer deixar de assinar todos os fóruns e discussões e desabilitar a assinatura automática?';
...
$string['unsubscribeallconfirmforeacts'] = 'Atualmente você está assinando  {$a->foreacts} fóruns. Você realmente quer deixar de assinar todos os fóruns e desativar a assinatura automática de discussão?';
...
$string['iconoptions'] = 'Cenário';
$string['iconoptions_help'] = 'Escolha o conjunto de reações que serão utilizadas nesse fórum';